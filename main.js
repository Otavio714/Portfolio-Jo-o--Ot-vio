...
const translations = {
  PT: {
    ...
    headerH1: 'João Otávio<br />Desenvolvedor <span class="color">front end</span>',     
    headerDesc: "Desenvolvedor front-end que transforma ideias em soluções visuais impactantes. Especialista em React.js, Tailwind CSS e JavaScript, crio interfaces modernas e acessíveis focadas na experiência do usuário. Minha missão é simplificar a complexidade, entregando experiências digitais fluidas e intuitivas.",
    headerBtn: "Contato",
    aboutH2: 'Sobre <span class="color">Mim</span>',
    aboutDesc: "Sou um desenvolvedor web com um toque criativo, focado em transformar visões em realidade.Especialista em construir soluções de alta performance com React.js, Tailwind CSS e Firebase. Minha base em HTML, CSS, JavaScript e Python me permite desenvolver aplicações responsivas, acessíveis e com um código limpo e escalável.Com uma paixão por superar expectativas, meu objetivo é sempre entregar projetos de alta qualidade e com foco na experiência do usuário.Vamos criar algo incrível juntos!",
    ...
    serviceDesc: [
      ...
      "Criamos bots inteligentes que automatizam atendimentos e melhoram a experiência dos seus clientes em diversos canais.",
      ...
      "Facilitamos sua jornada digital com soluções completas, rápidas e sem complicações — tudo em um só lugar."
    ],
    portfolioH2: 'Meu <span class="color">Portfólio</span>',
  ...
  EN: {
    ...
    headerH1: 'João Otávio<br /><span class="color">front end</span> <br />Developer',
    headerDesc: "Front-end developer who transforms ideas into impactful visual solutions. Specialist in React.js, Tailwind CSS and JavaScript, I create modern and accessible interfaces focused on the user experience. My mission is to simplify complexity by delivering fluid and intuitive digital experiences.",
    headerBtn: "Contact",
    aboutH2: 'About <span class="color">Me</span>',
    aboutDesc: "I'm a web developer with a creative touch, focused on turning visions into reality. Specialist in building high-performance solutions with React.js, Tailwind CSS and Firebase. My foundation in HTML, CSS, JavaScript and Python allows me to develop responsive, accessible applications with clean, scalable code. With a passion for exceeding expectations, my goal is to always deliver high-quality projects with a focus on user experience. Let's create something incredible together!",
    aboutBtn: "Talk to Me",
    ...
    serviceDesc: [
      ...
      "We create smart bots that automate care and improve your customers' experience on various channels.",
      ...
      "We facilitate your digital journey with complete, fast and uncomplicated solutions - all in one place."
    ],
    portfolioH2: 'My <span class="color">Portfolio</span>',
